...
const Home = () => {
  ...
  const [edituserDetails, setEditrUserDetails] = useState({});
          ...
          <tbody>
            {users.map((user) => (
              <tr key={user.id}>
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <p
                    className={`inline-flex rounded-full bg-opacity-10 px-3 py-1 text-sm font-medium ${user.status === "Active" ? "bg-success text-success" : "bg-danger text-danger"}`}
                  >
                    {user.status}
                  </p>
                </td>
                <td className="border-b border-[#eee] dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <button
                      ...
                      className="items-cente flex w-full rounded-sm text-left text-sm hover:bg-gray dark:hover:bg-meta-4"
                    >
                      <svg
                        className="fill-current"
                        width="16"
